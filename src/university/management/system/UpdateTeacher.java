...
//        cfcourse.setBackground(Color.PINK);
    ...
    while (rs.next()) {
        ...
        cfcourse.setText(rs.getString("education"));
        cfBRANCH.setText(rs.getString("department"));
    }
} catch (Exception e) {
    e.printStackTrace();
}
  ...
  public void actionPerformed(ActionEvent ae) {
    if (ae.getSource() == Submit) {
        ...
        try {
            String query = "UPDATE teacher SET Address='" + Address + "', email='" + email + "', phone='" + phone + "', education='" + course + "',department='" + branch + "' WHERE Id='" + empId + "'";
            Conn con = new Conn();

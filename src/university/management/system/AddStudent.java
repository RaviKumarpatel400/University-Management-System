    ...
    long first4 = Math.abs((ran.nextLong()%9000L)+1000L);
     ...
     AddStudent(){
        ...
        add(  roll);
         ...
         labelrollno = new JLabel("22010112"+first4); 
         labelrollno.setBounds(200, 200, 250, 30);
      ...
      public void actionPerformed(ActionEvent ae) {
          if(ae.getSource()==Submit){
            ...
            String branch=(String) cbBRANCH.getSelectedItem();
              ...
              try{
                  String query="insert into student values('"+name+"','"+fname+"','"+rollnum+"','"+dob+"','"+Address+"','"+phone+"','"+email+"','"+tenth+"','"+twelve+"','"+Addhar+"','"+course+"','"+branch+"')";
                  Conn con=new Conn();
